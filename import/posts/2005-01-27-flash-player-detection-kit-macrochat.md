...
[This macrochat](https://web.archive.org/web/20100106033858/http://www.macromedia.com/cfusion/event/index.cfm?event=detail&id=133668&loc=en_us) will explain how to create a Flash Player detection script from scratch, use the Detection Kit to create the script, and help you to understand why detecting the Flash Player on a website is important.
