...
First off you need to discover your longitude and latitude. If like me you don’t have a [GPS device](https://web.archive.org/web/20090522145154/http://froogle.google.co.uk/froogle?q=gps) then you can use a number of online resources. I plumped for [Streetmap](https://web.archive.org/web/20090522145154/http://www.streetmap.co.uk/). Simply enter your postcode and then on the map screen scroll down to find the line of text that reads “Click here to convert/measure coordinates”. Click on the link and make a note of the latitude and longitude figures that are returned.  

`Lat: N 51:23:31 ( 51.391924 ) Long: W 0:44:45 ( -0.745941 )`

### Step 2 – Generate ‘Geo’ or ‘ICBM’ tags

Now we can generate the most commonly used geographical tags to place in the head of our web pages. I used the [Geo Tag Generator](https://web.archive.org/web/20090522145154/http://geotags.com/geo/DMS3.html) at ‘Geotags.com’ to generate by ‘geo’ tags and the instructions for [adding a site to the GeoURL database](https://web.archive.org/web/20090522145154/http://geourl.org/add.html) at ‘GeoURL.org’ to generate my ICBM tags.
...
- [Feedmap.net](https://web.archive.org/web/20090522145154/http://www.feedmap.net/BlogMap/submit.aspx)
