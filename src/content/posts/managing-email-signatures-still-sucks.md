...
Of course over time… all of this just continues to drift, until the next round of “can everyone update their signatures please” and the cycle repeats... :D
...
It amazes me that in the seventeen years that have passed since that post… neither Microsoft or Google have done anything meaningful to resolve this gap - thankfully a bunch of independent businesses have emerged around providing a solution (we’ll be checking these out!).
