...
**Update:** As pointed out by Philip there are [some issues](http://twitter.com/synx508/status/91496649033138178) with this approach so tread carefully people, I’ve only tested this concept in a scenario where the current date falls within the same month/year etc.
