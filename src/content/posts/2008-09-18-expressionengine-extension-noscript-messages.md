...
I wanted to ‘do the right thing’ and ‘hacked’ an alternative as documented in [this thread](http://expressionengine.com/forums/viewthread/85472/) on the ExpressionEngine Forums. This hack picked up the referring page URL and passed that to the User Message template instead.
