...
After what seemed like an age we settled on a name ([Nine Four](http://www.ninefour.co.uk/)) and purchased the only available domains, the .co.uk and .net. The .com was already registered but not in use so we held out some small hope that we might manage to get hold of it one day.
...
So I read up on Mike Davidson’s Blog about [his experience snatching ‘newsvine.com’](http://www.mikeindustries.com/blog/archive/2005/03/how-to-snatch-an-expiring-domain) and formulated a plan of attack.
...
Mike suggests using [SnapNames.com](http://snapnames.com/), [Enom.com](http://www.enom.com/) and [Pool.com](http://www.pool.com/). Enom.com didn’t seem to have an obvious option for back-ordering a domain name so in the end I went with [NameJet.com](http://www.namejet.com/).
