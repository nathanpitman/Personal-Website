...
I already own a fully licensed copy of Fireworks 8, but after my beta copies of Dreamweaver and Flash decided to time out I bit the bullet and purchased a Studio 8 upgrade from [DABS](http://www.dabs.com/). I have 2 boxed copies of ‘Studio MX 2004 Pro’, plus the boxed copy of ‘Fireworks 8’ so I assumed that I had more than was required to qualify for the upgrade as opposed to the full product version.
...
**Update:** Drew is indeed right, seems I was using serials from a NFR (Not for Resale) copy of Studio MX. However there are a [bunch of other products you can upgrade from](http://www.macromedia.com/store/en_gb/popup/software/studio/upgrade_eligibility.html).
