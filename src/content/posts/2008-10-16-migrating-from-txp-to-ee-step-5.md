...
However this is not the route I’m going to take. Personally I would much rather maintain my ‘noteworthy’ links using a tool like [Delicious](https://web.archive.org/web/20090518092434/http://delicious.com/) so I’m going to show you how we can migrate our Textpattern links to Delicious and then have them displayed inline within an ExpressionEngine template.

Luckily for us there’s a fantastic Textpattern Extension called [ajw\_bookmarks](https://web.archive.org/web/20090518092434/http://compooter.org/2007/01/textpattern-plugin-ajw-bookmarks/) that provides us with a quick and easy way to export our Links to a ‘Bookmarks’ file which most bookmark services and browsers can import.
...
Now that we have our locally saved Bookmarks file navigate to the [Import Bookmarks](https://web.archive.org/web/20090518092434/https://secure.delicious.com/settings/bookmarks/import) tool on the Delicious website (obviously you will need to log-in first) and then choose the ‘Custom import’ option.
...
You should now have a nice unordered list displaying your 10 most recent Delicious bookmarks or my 10 most recent Delicious bookmarks if you forgot to change the username in the URL. ![smile](https://web.archive.org/web/20090518092434im_/http://nathanpitman.com/images/smileys/smile.gif)
