...
The device that I opted for was the ‘[Slim Devices](http://www.slimdevices.com/)‘ SLIMP3 Player. I placed my order through a UK distributor and within less than 2 days the unit arrived complete with appropriate cabling. Before running the 20 metre network cable from upstairs office to downstairs lounge I plugged the unit in for a quick test. Everything worked, the player connected to the network and detected the SlimServer (The PC on which I had installed the Server software).
