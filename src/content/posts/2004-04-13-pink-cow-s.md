...
We wrote the CMS using [PHP](http://www.php.net/) and [MySQL](http://www.mysql.com/) and developed the public facing site using CSS for positioning and styling. I think the end result is pretty neat. I’d be interested to hear your opinions on both the design and the execution…
