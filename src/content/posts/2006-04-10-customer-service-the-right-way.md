...
For the past month or so I’ve been working on a [Expression Engine](http://www.expressionengine.com/index.php?affiliate=nathanpitman) powered website for a client. The last few evenings I’ve been adding finishing touches, making last minute tweaks etc.
...
According to the maual, this should have worked without complaint, to begin with it did. However as I continued to link my existing entries to the relevant event records I stumbled across some weirdness. A quick search on the [Expression Engine forums](http://www.pmachine.com/forums/) turned up [a thread](http://www.pmachine.com/forums/viewthread/32405/) which documented a similar problem, I posted a response outlining my problem and within a few hours of that initial posting I have a patched file from the development team which fixes the bug.
