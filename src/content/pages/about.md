...
Alongside his coursework, Nathan ran **.matrix**, his own contributor chapter of [Head-Space](https://head-space.org/) — the non-commercial community project spun out of the Brixton agency Head New Media, later credited by *Management Today* as one of the ["Ten Websites That Changed the World"](https://www.managementtoday.co.uk/10-websites-changed-world/article/1102817) and included in the touring *Digital Archaeology* exhibition. It was an early, formative outlet for his Flash and Shockwave experiments — [read more about that chapter](/posts/the-head-space-project/).
