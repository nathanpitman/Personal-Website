...
Alongside his coursework, Nathan ran **.matrix**, his own contributor chapter of [Head-Space](https://head-space.org/) — the non-commercial community project spun out of the Brixton agency Head New Media that won a **Cannes Lion in 1999** for Best Online Community, and which *Management Today* later [called](https://www.managementtoday.co.uk/10-websites-changed-world/article/1102817) "the blueprint for intranets everywhere — and YouTube." It was an early, formative outlet for his Flash and Shockwave experiments — [read more about that chapter](/posts/the-head-space-project/).
